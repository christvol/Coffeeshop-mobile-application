-- Create a table to store country codes
CREATE TABLE CountryCodes (
    [id] INT IDENTITY(1, 1),
    -- Country ticker (e.g., AF for Afghanistan)
    countryTicker CHAR(2) NOT NULL PRIMARY KEY,
    -- Country code (e.g., +93 for Afghanistan)
...
INSERT INTO CountryCodes (countryTicker, countryCode, countryName) VALUES
('AF', '+93', 'Afghanistan'),
('AL', '+355', 'Albania'),
('DZ', '+213', 'Algeria'),
...
('ZW', '+263', 'Zimbabwe');
GO
-- Select all data from CountryCodes
